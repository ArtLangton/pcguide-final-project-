...
const registerRoute = async (req, res) => {
    ...
    try {
        ...
        res.status(201).json({ message: 'Registration Successful', user: newUserReq });
    } catch (err) {
...
const getCategoryProducts = async (req, res) => {
    ...
    console.log("Fetching products for category:", category_name);
    try {
...
const getOrders = async (req, res) => {
    ...
    try {
        ...
        console.log('Error getting orders from database', err);
        res.status(500).send([]);
    }
};
