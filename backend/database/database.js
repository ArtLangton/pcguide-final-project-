...
const queryProducts = async () => {
    const query = `SELECT products.product_id, products.name,products.price,products.description,products.brand,
    categories.name AS category_name,products.attributes,products.links
    FROM products
...
const updateItemQuantity = async (user_id, item_id, quantity) => {
    ...
    try {
        ...
        console.log('Error updating item quantity in database', err);
        throw err;
    }
}
